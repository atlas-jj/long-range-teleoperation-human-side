...
//            }
    ...
    void ModelDrawer::SetTarget(pangolin::OpenGlMatrix &Twc, Eigen::Vector3d t)
    {
        ...
        if (diff.squaredNorm() > 0.0) {
            ...
            //     }
            // }
            // target_w[0] = (vpMPs[nearestIndex]).at<double>(0);
            // target_w[1] = (vpMPs[nearestIndex]).at<double>(1);
            // target_w[2] = (vpMPs[nearestIndex]).at<double>(2);
        }
        //cout<<"selected target: "<<target_w<<endl;
    }
