...
namespace dlovi{
    ...
    namespace compvis{
        ...
        public:
            ...
            void stepTranscriptCommandStr(const std::string & cmdStr);
        ...
        private:
            ...
            int stepTranscriptBody_cmd(std::string strCurrentLine, EntryType & enumEntryType, EntryData & objEntryData, std::vector<dlovi::Matrix> & arrPoints,
                                  std::vector<dlovi::Matrix> & arrCamCenters, std::vector<std::vector<int> > & arrVisLists, int nLoop);
            void markAsValid();
